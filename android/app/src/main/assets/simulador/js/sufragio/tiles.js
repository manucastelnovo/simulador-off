var pantallas = [
  ...
  {"id": "pantalla_mensaje_final",
   ...
   "template_data_callback": popular_pantalla_mensaje_final
  },
...
var contexto = [
    ...
    {
        id: "agrupacion_nivel_ubicacion",
        container: "#contenedor_opciones",
        template: "btn_agrupacion_nivel_ubicacion",
    },
    {
    ...
    },
    {
        ...
        callback_show: function () {
            document
                ...
                .classList.add("con-categoria-votada");
        },
        callback_hide: function () {
            document
                .querySelector("#encabezado")
                .classList.remove("con-categoria-votada");
        },
    },
    {
        id: "alto_contraste",
    ...
    { id: "indicador_asistida", container: "#asistida_container" },
];
